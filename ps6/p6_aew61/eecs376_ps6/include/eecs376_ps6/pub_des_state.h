#pragma once
#ifndef EECS376_PS6_PUB_DES_STATE_H
#define EECS376_PS6_PUB_DES_STATE_H

#include <ros/ros.h>
#include <queue>
#include <eecs376_ps6/TrajBuilder.h> //has almost all the headers we need
#include <std_msgs/Float64.h>
#include <std_msgs/Bool.h>
#include <std_srvs/Trigger.h>
#include <eecs376_ps6/Path.h>
...
private:
    ...
    bool appendPathQueueCB(eecs376_ps6::PathRequest& request, eecs376_ps6::PathResponse& response);

    void lidar_alarm_CB(const std_msgs::Bool& alarm_msg);
...
public:
    ...
    void append_path_queue(double x, double y, double psi)
        { path_queue_.push(trajBuilder_.xyphi_to_pose_stamped(x,y,psi)); }
};
#endif // end of EECS376_PS6_PUB_DES_STATE_H
