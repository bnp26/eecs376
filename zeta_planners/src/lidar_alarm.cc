...
// C++ PROJECT INCLUDES
#include "zeta_planners/lidar_parser.h"
...
int main(int argc, char** argv)
{
	...
	ros::init(argc, argv, "eecs376_ps6_lidar_alarm_node");
  	ros::NodeHandle n_handle;

    //create a publisher and have it publish the lidar_alarm topic
    lidar_alarm_pub = n_handle.advertise<std_msgs::Bool>("lidar_alarm", 1);
    ros::Subscriber lidar_subscriber = n_handle.subscribe("/scan", 1, laser_callback);
