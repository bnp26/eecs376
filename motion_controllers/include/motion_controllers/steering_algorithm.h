...
const double K_PHI= 7.0; // control gains for steering
const double K_DISP = 3.0;
const double K_TRIP_DIST = 3.0; ///1.0
...
private:
    ...
    void getInitialStateCallback(const nav_msgs::Odometry& init_state);  
    bool is_init_state_received_;
}; 
